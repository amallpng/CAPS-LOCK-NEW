...
interface ChallengeSignupModalProps {
  user: User;
  onClose: () => void;
  onSignup: (name: string, dob: string) => void;
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-[var(--color-primary)] mb-2 text-center">One Last Thing!</h2>
        <p className="text-[var(--color-text-muted)] text-center mb-6">
          Please verify your name and enter your date of birth to continue.
        </p>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--color-text-muted)] mb-2" htmlFor="challenge-dob">Date of Birth</label>
            <input
              id="challenge-dob"
              type="date"
              value={dob}
